(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('vue-property-decorator'), require('lodash')) :
    typeof define === 'function' && define.amd ? define(['exports', 'vue-property-decorator', 'lodash'], factory) :
    (global = global || self, factory(global.CCIPSessionTable = {}, global.vuePropertyDecorator, global._));
}(this, (function (exports, vuePropertyDecorator, _) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    __decorate([
        vuePropertyDecorator.PropSync('isPopup', {
            default: false,
            required: false
        })
    ], CCIPSessionTable.prototype, "childIsPopup", void 0);
    __decorate([
        vuePropertyDecorator.PropSync('popUpSession', {
            default: {},
            required: false
        })
